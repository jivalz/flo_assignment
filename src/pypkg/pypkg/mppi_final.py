...
def laserscan_to_world_frame(scan:LaserScan, rb_x : float,rb_y : float,rb_yaw : float, max_range : float=1.0,min_range : float=0.05,) -> np.ndarray:
...
class mppinode(Node):
    ...
    def _scan_callback(self, msg: LaserScan):
        ...
        self.scan_pts = laserscan_to_world_frame(msg, rx, ry, ryaw, max_range=1.0, min_range=0.1)
